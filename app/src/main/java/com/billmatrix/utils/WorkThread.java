...
public class WorkThread extends Thread {
    ...
    public void setDeviceAddress(String deviceAddressString) {
        this.deviceAddressString = deviceAddressString;
    }
    ...
    public void connectNet(String IPAddress, int PortNumber) {
        if ((null != workHandler) && (null != mLooper)) {
            Message msg = workHandler.obtainMessage(Global.MSG_WORKTHREAD_HANDLER_CONNECTNET);
            msg.arg1 = PortNumber;
            msg.obj = IPAddress;
            workHandler.sendMessage(msg);
        } else {
    ...
    public void connectUsb(USBPort port, TTYTermios serial) {
        if ((null != workHandler) && (null != mLooper)) {
            Message msg = workHandler.obtainMessage(Global.MSG_WORKTHREAD_HANDLER_CONNECTUSB);
