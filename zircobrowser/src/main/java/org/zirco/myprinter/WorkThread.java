        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case Global.MSG_WORKTHREAD_HANDLER_CONNECTBT: {
                    ...
                    Message smsg = targetHandler.obtainMessage(Global.MSG_WORKTHREAD_SEND_CONNECTBTRESULT);
                    if (result) {
                        smsg.arg1 = 1;
                    } else {
                        smsg.arg1 = 0;
                ...
                case Global.MSG_WORKTHREAD_HANDLER_CONNECTNET: {
                    ...
                    Message smsg = targetHandler.obtainMessage(Global.MSG_WORKTHREAD_SEND_CONNECTNETRESULT);
                    if (result) {
                        smsg.arg1 = 1;
                    } else {
                        smsg.arg1 = 0;
                ...
                case Global.MSG_WORKTHREAD_HANDLER_CONNECTUSB: {
                    ...
                    Message smsg = targetHandler.obtainMessage(Global.MSG_WORKTHREAD_SEND_CONNECTUSBRESULT);
                    if (result) {
                        smsg.arg1 = 1;
                    } else {
                        smsg.arg1 = 0;
                ...
                case Global.CMD_WRITE: {
                    ...
                    Message smsg = targetHandler.obtainMessage(Global.CMD_WRITERESULT);
                ...
                case Global.CMD_POS_WRITE: {
                    ...
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_WRITERESULT);
                ...
                case Global.CMD_POS_SETKEY: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_SETKEYRESULT);
                ...
                case Global.CMD_POS_CHECKKEY: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_CHECKKEYRESULT);
                    if (result) {
                ...
                case Global.CMD_POS_PRINTPICTURE: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_PRINTPICTURERESULT);
                    if (result) {
                ...
                case Global.CMD_POS_SALIGN: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_SALIGNRESULT);
                    if (result) {
                ...
                case Global.CMD_POS_SETLINEHEIGHT: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_SETLINEHEIGHTRESULT);
                    if (result) {
                ...
                case Global.CMD_POS_SETRIGHTSPACE: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_SETRIGHTSPACERESULT);
                    if (result) {
                ...
                case Global.CMD_POS_STEXTOUT: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_STEXTOUTRESULT);
                    if (result) {
                ...
                case Global.CMD_POS_SETCHARSETANDCODEPAGE: {
                    ...
                    int timeout = 1000;
                    boolean result = Pos.POS_QueryStatus(precbuf, timeout);
                    Message smsg = targetHandler.obtainMessage(Global.CMD_POS_SETCHARSETANDCODEPAGERESULT);
                    if (result) {
